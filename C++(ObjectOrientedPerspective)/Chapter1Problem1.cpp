...
/*Program discription:
	1.)This program takes the sum of two integers and adds them togeather.
	2.)It then displays the total sum value of the two integers
*/
...
int chpt1prb1() {
	...
	int b = 100;
	int total = a + b;
	cout << "The total sum of a + b is: " << total;
	return 0;
}